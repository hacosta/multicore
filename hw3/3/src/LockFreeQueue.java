...
public class HW3P3 {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                if(random.nextBoolean()) {
                    ...
                    try {
                        System.out.println("last Head : " + MyQueue.deq().toString());
                    } catch (NullPointerException ex) {System.out.println("null exception"); }
                    sleep(random.nextInt(64));
                }
            }
        };
    ...
    public static void main(String args[]) {
        ...
        //run either test case, it will hang because threads will wait forever for deq in parallel test
        //String[] protocolTypes = {"LOCK"};
        String[] protocolTypes = {"LOCK Free"};
